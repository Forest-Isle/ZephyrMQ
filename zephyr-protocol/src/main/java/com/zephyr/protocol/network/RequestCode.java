...
public class RequestCode {
    ...
    public static final int GET_ROUTEINTO_BY_TOPIC = 105; // Alias for typo compatibility
    ...
    public static final int GET_KVLIST_BY_NAMESPACE = 219; // Alias for compatibility
    ...
    public static final int UNIT_MESSAGE = 311;
    public static final int GET_ALL_UNIT_MODE = 312;
    public static final int GET_ALL_UNIT_MODE_NAME = 313;
    ...
    // Additional constants for NameServer
    public static final int GET_UNIT_TOPIC_LIST = 322;
    public static final int GET_HAS_UNIT_SUB_TOPIC_LIST = 323;
    public static final int GET_HAS_UNIT_SUB_UNUNIT_TOPIC_LIST = 324;
}